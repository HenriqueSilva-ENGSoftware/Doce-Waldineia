...
function injetarEstilos() {
    ...
    .timeline-content::after {
        ...
        background: #e6b981;
        border-radius: 50%;
        box-shadow: 0 0 0 4px #fff, 0 0 0 6px #e6b981;
    }
    ...
    @media (max-width: 640px) {
        ...
        .timeline-content::after { right: auto !important; left: -38px !important; }
...
function construirPagina() {
    ...
    main.innerHTML = `
        ...
        <div class="about-wrapper">
            <h2 class="section-titulo fade-in" style="margin-top:0;padding-top:60px">
                Nossos Valores
            </h2>
            <p class="section-subtitulo fade-in">
                O que norteia cada encomenda que sai da nossa cozinha.
            </p>
            ...
            <p class="section-subtitulo fade-in">
                De uma cozinha de casa para centenas de clientes felizes.
            </p>
            <div class="timeline">
                ${HISTORIA.map((h, i) => `
                    <div class="timeline-item">
                        ${i % 2 === 0 ? '<div class="timeline-spacer"></div>' : ''}
            ...
            <div class="about-cta fade-in">
                ...
                <div class="cta-btns">
                    <a href="../Produtos/produtoIndex.html" class="btn-cta-primary">
                        Ver Produtos
                    </a>
                    <a href="../Contato/contatoIndex.html" class="btn-cta-secondary">
                        Entrar em Contato
                    </a>
                </div>
            </div>
